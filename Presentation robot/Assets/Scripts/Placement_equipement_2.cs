...
public class Placement_equipement_2 : MonoBehaviour
{
    ...
    public static bool carte_2_position_2;
    ...
    public static bool carte_2_position_3;
    ...
    void Start()
    {
        carte_2_position_1 = false;
        x_position_1_carte_1 = -1.62f;
        y_position_1_carte_1 = 0.651f;
        x_position_1_carte_2 = -1.62f;
        y_position_1_carte_2 = 0.5f;
        x_position_1_carte_3 = -1.62f;
        y_position_1_carte_3 = 0.338f;

        carte_2_position_2 = false;
        x_position_2_carte_1 = 0.04f;
        y_position_2_carte_1 = 0.651f;
        x_position_2_carte_2 = 0.04f;
        y_position_2_carte_2 = 0.5f;
        x_position_2_carte_3 = 0.04f;
        y_position_2_carte_3 = 0.338f;

        carte_2_position_3 = false;
        x_position_3_carte_1 = 1.5f;
        y_position_3_carte_1 = 0.651f;
        x_position_3_carte_2 = 1.5f;
        y_position_3_carte_2 = 0.5f;
        x_position_3_carte_3 = 1.5f;
        y_position_3_carte_3 = 0.338f;
    }
    ...
    void Update()
    {
            ...
            equipement.transform.position.x != x_position_1_carte_3)
        {
            ...
            {              
                switch (Nb_carte_position.nb_carte_position_1)
                {
                    case 1:
            ...
            equipement.transform.position.x != x_position_2_carte_3)
        {
                ...
                equipement.transform.position.y != y_position_2_carte_3)
            {
                ...
                switch (Nb_carte_position.nb_carte_position_2)
                {
                    case 1:
            ...
            equipement.transform.position.x != x_position_3_carte_3)
        {
                ...
                equipement.transform.position.y != y_position_3_carte_3)
            {
                ...
                switch (Nb_carte_position.nb_carte_position_3)
                {
                    case 1:
